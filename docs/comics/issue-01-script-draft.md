...
**Source Route:** `docs/comics/issue-01-hype-machine-route.md`

**Page Map:** `docs/comics/issue-01-page-breakdown.md`

**Print Container:** `docs/comics/mixam-24-page-template-spec.md`

---

## Quarantine Notice

This document belongs only in the comic sandbox repository.
...
This script may compress, dramatize, rearrange, or visually foreshadow material from Meridian Prime canon. Nothing in this file becomes main canon automatically.

---

## Working Issue Identity

**Working title:** Meridian Prime: The Route To It

**Format:** 24-page US Standard comic, single pages in reading order.

**Content mode:** Hype issue / pitch comic / teaser adaptation.

**Core premise:**

> Rob's death was a map.

**Reader-facing engine:**

> Tenet thinks he accepted a job.  
> Rob had already sent him to a door.

---

## Script Format Key

- **Visual:** What the artist should draw.
- **Caption:** Narration, document text, or atmospheric text.
- **Dialogue:** Character speech.
- **SFX:** Sound effects.
- **Lettering Note:** Instructions for balloons, captions, UI, packet text, or placement.
- **Reveal Control:** What the page may imply but must not fully explain.
...
**Adaptation Label:** Non-Canon Promo / Adaptation Art

**Panel Count:** 1 full-bleed cover image

**Page Purpose:** Sell the entire hype route in one impossible image: Red Umbrielor, Tenet, the hidden formation, Rob's death-shadow, Horus's official pressure, and the sense that Meridian Prime itself has answered the route.

## Cover Image

**Visual:** Full-bleed cover. Red Umbrielor / MMS Quadtrack 289 faces a vast cracked formation under a bruised alien dawn. The machine is massive, scarred, frost-caked, red panels patched in different shades, number `289` visible but weather-worn. Tenet stands small in the foreground, dressed as a field operator, not a superhero. One hand holds or rests near the MITE II packet. The pistol is implied by silhouette, coat line, or the weight of his stance rather than brandished.

Behind the formation, barely readable through cold haze and signal distortion: Rob Holliday's warm, sad face, Horus Skelton as a dark official shape, and mirrored but non-identical world-shapes suggesting Aeonos / ˾onos without explaining them.
...
The job was legal. The map was dead. The route answered anyway.

**Lettering Note:** Title, creator placeholders, issue number, and tagline must stay inside safe area. Any spectral background elements may bleed.

**Reveal Control:** Symbolic hype only. Do not explain the formation, Core, Aeonos / ˾onos, Rob's death-chain, or pistol function.

---

# PAGE 2

**Page Role:** Inside Front Cover / Credits

**Adaptation Label:** Candidate Canon for packet-style design language; otherwise production layout

**Panel Count:** No traditional panels. Artifact / document layout.

**Page Purpose:** Make the comic feel like a leaked route document or corrupted field packet. Establish production credits while building mood.

## Layout

**Visual:** Clean credits page styled as an NCI / World Works field packet. White-gray field-document background with faint grid lines, route map fragments, clipped approval blocks, cold blue UI traces, and a few redacted bars. A ghost of the MITE II packet runs behind the credits at low opacity.

**Document Header Text:**

NCI INTERNAL FIELD COPY  
MITE II PROPOSED ROUTE ACCESS / SURVEYING AND PROOFING  
REVIEW STATUS: DISPUTED

**Credits Placeholders:**

Series Title: MERIDIAN PRIME  
Issue: THE ROUTE TO IT  
Writer: [Name]  
Artist: [Name]  
Colorist: [Name]  
Letterer: [Name]  
...
Field packets do not guarantee field truth.

**Lettering Note:** Keep all credits inside safe area. The packet graphics may extend toward trim but should not compromise readability.

**Reveal Control:** Horus approval motifs may appear as texture, but the dramatic Horus reveal must wait until Page 8.

---

# PAGE 3

**Page Role:** Interior Page 1

**Adaptation Label:** Adaptation Choice / Comic-Only Continuity

**Panel Count:** 4 panels

**Page Purpose:** Open on Rob Holliday at The House Ten Built. Establish that the dead man has already made a move before Tenet knows he is on the board.

## Panel 1

**Visual:** Wide exterior. The House Ten Built sits alone in brutal Meridian Prime cold. Not famous, not grand, not picturesque. A small legacy cabin swallowed by pressure weather, old route dark, and endless hard distance. One warm light burns in a window.
...
Far enough off active routes that official maps had to squint before lying about it.

**Lettering Note:** Captions should feel like field-report narration with a human edge.

## Panel 2

**Visual:** Interior. Old route maps, tools, photographs, dust, oilcloth, field notes, and worn furniture. A place built by people who trusted objects more than records. A photograph is visible but not emphasized: three young men beside a military MMS Quadtrack.

**Caption:**

Rob Holliday had spent his life refusing bad paperwork, worse weather, and men who mistook access for trust.

## Panel 3

**Visual:** Rob Holliday at a table. White hair swept to one side, square glasses, mustache connected to goatee, curled eyebrow tips, overweight but not obese. He wears a salmon polo under cold-weather layers left open indoors. He looks sick: tired, thinner than he should be, but warm-eyed and present. One hand rests near an old oilcloth bundle's absence, as if something important was recently there and now is not.

**SFX:**

KTTK

**Lettering Note:** The sound is a small stove/heater tick, not a dramatic noise.

## Panel 4

**Visual:** Rob looks toward the door. Outside, headlights or field lamps cut through cold darkness. He smiles faintly, the way a man smiles when the last bad appointment finally arrives late.

**Rob Dialogue:**

Took you long enough.

**Reveal Control:** Show Rob is ill and waiting. Do not explain the poison, the Core, or what exactly he moved.

---

# PAGE 4

**Page Role:** Interior Page 2

**Adaptation Label:** Adaptation Choice / Comic-Only Continuity

**Panel Count:** 5 panels

**Page Purpose:** Establish Horus as personal, official, wounded, and too late. Rob's refusal becomes the issue's first moral detonation.

## Panel 1

**Visual:** Horus Skelton stands in the open doorway, cold behind him like another uniform. He is controlled, official, weathered by age and power. His silhouette should suggest decades of Traverse authority, not random villainy.
...
That's the voice people use when they want a favor and brought a threat in case manners fail.

## Panel 2

**Visual:** Horus inside now, door closed behind him. He does not remove all his outer gear. He is not staying. Rob remains seated, conserving strength, but he owns the room by refusing to be impressed.
...
Do not make this smaller than it is.

## Panel 3

**Visual:** Close on Rob. Warm smile. Eyes sharp behind square glasses. Eyebrow tips curled like tiny weather hooks.

**Rob Dialogue:**

Horus, you made everything smaller the day you started calling old friends assets.

## Panel 4

**Visual:** Close on Horus's gloved hand on the back of a chair. He grips it too hard. In the background, the photograph of the three young men is now slightly clearer, but still not explained.

**Horus Dialogue:**

Ten left something here.

**Rob Dialogue, off-panel:**

Ten left a lot of things. Tools. Debt. Bad coffee. Better judgment than either of us deserved.
...
**Lettering Note:** Rob's final word should be large enough to hit but not superhero-sized. It is a verdict, not a punchline.

**Reveal Control:** May imply Horus came for route truth or access. Do not reveal full House secrets, Core mechanics, or exact pistol function.

---

# PAGE 5

**Page Role:** Interior Page 3

**Adaptation Label:** Canon Reference with heightened visual pacing

**Panel Count:** 5 panels

**Page Purpose:** Hard cut from Rob's final refusal to Tenet's working morning. Establish Red Umbrielor, Tenet's competence, the cold, and the practical texture of the world.

## Panel 1

**Visual:** Tenet's gloved hand pressed against scarred red steel. Frost catches in chipped paint. The panel is tactile: cold metal, field grime, worn glove seams.
...
Before dawn, Red Umbrielor complained correctly.

## Panel 2

**Visual:** Wider shot. Red Umbrielor / MMS Quadtrack 289 sits massive in the half-asleep NCI yard. Field lamps, vapor, fuel crews, old Mods, and dark blocks of machinery in the background. The number `289` is stenciled beneath frost, partly worn away.
...
**Visual:** Diagnostic strip on the machine. Amber warning.

**Diagnostic Text:**

MD-8 PRESSURE UNEVEN

**Tenet Dialogue, off-panel:**

Yeah.

## Panel 4

**Visual:** Tenet watches the warning for a few breaths. He is calm, experienced, and tired in the way people are tired before work rather than after it. The warning clears.
...
**Visual:** Tenet climbs the ladder toward the cab. Behind him, NCI wakes in grudges: fuel handlers, mechanics arguing quietly, Mods being coupled, cold exhaust. Red Umbrielor's scale dominates the page.

**Caption:**

Catastrophe had a different sound.

**Reveal Control:** No Rob explanation yet. The cut itself implies connection.

---

# PAGE 6

**Page Role:** Interior Page 4

**Adaptation Label:** Canon Reference

**Panel Count:** 6 panels

**Page Purpose:** Let grief enter through machine ritual: dead defrost, turkey roaster, empty passenger seat, under-seat pistol weight.

## Panel 1

**Visual:** Cab interior. Frosted windshield. Yard lights smeared into blurry ghosts. Tenet reaches for the defrost control.
...
**Visual:** Defrost vent gives almost nothing. Tenet gives the dash a flat look he learned from Rob.
...
**Visual:** Tenet kicks on the turkey roaster: an improvised auxiliary heater in a bolted cage, glowing dull orange. It looks like a bad decision that survived enough winters to become procedure.
...
The turkey roaster came alive with the confidence of a field fix nobody wanted to explain to insurance.

## Panel 4

**Visual:** The windshield clears in a half-moon. Warm light touches the cab. The passenger seat sits empty.
...
**Visual:** A small memory ghost in the empty seat: not a literal apparition, just composition. A salmon sleeve implied, a duffel shape that is not really there, Rob's absent warmth in the place where he used to sit.

**Rob Memory Dialogue, faint:**

Defrost's bullshit.

**Lettering Note:** Rob memory dialogue should be faint or visually distinct, not a ghost scene.

## Panel 6

**Visual:** Tenet leans down and checks the under-seat compartment. Close on his hand near the latch. The compartment is closed, locked. We do not need to see the pistol clearly, only the weight of it.
...
**Reveal Control:** The pistol is planted as inheritance and weight. Do not explain key/test/function.

---

# PAGE 7

**Page Role:** Interior Page 5

**Adaptation Label:** Canon Reference with comic pacing

**Panel Count:** 5 panels

**Page Purpose:** Bring Lindy into the cab threshold with family friction, dispatch competence, and the MITE II packet.

## Panel 1

**Visual:** Lindy Nocsid crosses the staging yard with a dispatch slate tucked under one arm and a hardcopy packet under the other. She moves like irritation learned to wear boots. Field crews part without making a ceremony of it.

**Caption:**

Lindy Nocsid did not wave.

**Caption:**

Lindy considered waving an admission that people were far away from each other.

## Panel 2

**Visual:** Lindy climbs the side step and leans into Red Umbrielor's cab doorway. Thermal cap low, sharp eyes, small frame carrying more authority than her job title admits.

**Lindy Dialogue:**

Your defrost still dead?
...
**Visual:** Lindy sniffs the cab air with theatrical suspicion. The turkey roaster glows behind Tenet.
...
Until the defrost remembers the contract.

**Lindy Dialogue:**

Defrost never signed. Defrost had legal review.

## Panel 4

**Visual:** She shoves the packet at him. The hardcopy is in a field sleeve, stiff with cold. At the same time, the digital twin blinks onto Red Umbrielor's dash.
...
MITE II PROPOSED ROUTE ACCESS / SURVEYING AND PROOFING PACKAGE  
NCI INTERNAL FIELD COPY  
CONTRACT DESIGNATION: HEO-IC / FIELD LEAD
...
**Page Role:** Interior Page 6

**Adaptation Label:** Canon Reference / dramatic page-turn

**Panel Count:** 4 panels

**Page Purpose:** Deliver the first major wrongness: Horus Skelton's approval stamp. The job is legal, clean, and wrong by scale.

## Panel 1

**Visual:** Tenet flips or scrolls through the packet. Physical paper and digital overlay align imperfectly. The paperwork is too clean. Lindy's reflection appears faintly over the screen or treated paper.

**Caption:**

The mission read clean.

**Caption:**

Too clean was not the same as good.

## Panel 2

**Visual:** Close on route language and authorization chain. The reader sees enough to understand it is official, leased, permissioned, and scrubbed.

**Packet Text:**

NCI REQUEST LOGGED  
LEASE REVIEWED  
ROUTE ACCESS PROVISIONALLY GRANTED  
WORLD WORKS CONCURRENCE ATTACHED
...
**Visual:** Huge close-up. Final approval line fills most of the panel. It should feel cold, official, and violent without movement.

**Packet Text:**

FINAL APPROVAL:  
HORUS SKELTON  
WORLD WORKS DIRECTOR OF TRAVERSE OPERATIONS

**Lettering Note:** This is the page's visual thunderclap. Keep text crisp and readable.

## Panel 4

**Visual:** Tenet stares at the approval line. The cab seems quieter. Lindy watches him, already knowing what he saw. The turkey roaster glows between them like a tiny guilty furnace.
...
**Reveal Control:** Show Horus's approval as wrong by scale. Do not reveal full Horus plan, assassin, Core, hidden formation, or Rob's full death truth.
...
**Page Role:** Inside Back Cover / In-World Warning Ad

**Adaptation Label:** Adaptation Choice / Candidate Canon for poster language

**Panel Count:** No traditional panels. Poster / ad page.

**Page Purpose:** Let the reader breathe after Page 22 while reinforcing Traverse culture. This page should function as both a comic back-matter ad framework and an in-world warning poster.

## Poster Layout

**Visual:** Full-page in-world NCI / Traverse warning poster. Weathered field-paper texture over full-bleed industrial cold. A simplified silhouette of Red Umbrielor and a Mod train crosses a black-flagged route in the lower third. The upper field is open enough for big typography. Background may include faint packet fragments, route markers, old approval blocks, and a ghost of the Page 13 signal motif.

**Primary Poster Text:**

THINGS ARE DIFFERENT ON TRAVERSE.

**Secondary Poster Text:**

NCI accepts private route contracts, field repairs, survey support, and bad decisions with paperwork.

**Small In-World Text:**

Ask your Lead before trusting the map.  
Ask your mechanic before trusting the machine.  
Ask your signal tech before trusting the silence.
...
THE FAMILY / THE COMPANY / FIELD WORK DONE UGLY

**Lettering Note:** The required production note must remain readable and inside the safe area. Poster headline can be large and stark. Background graphics may extend to bleed.

**Reveal Control:** No new story reveal. This is a culture echo, not an extra plot page.

---

# PAGE 24

**Page Role:** Back Cover / Back-Story Image Page

**Adaptation Label:** Non-Canon Promo / Adaptation Art

**Panel Count:** 1 full-bleed back-cover image

**Page Purpose:** End where the issue began: The House Ten Built in the cold, one light still burning. Close on Rob's agency, not plot explanation.

## Back Cover Image

**Visual:** Full-bleed image of The House Ten Built, tiny against Meridian Prime cold. The landscape is vast, lethal, and quiet. One warm light burns in the cabin window. A faint suggestion of old tracks leads away from the house, almost lost under new frost. The composition should echo Page 3 but feel more mythic and final.

No figures need to be visible. If any silhouette appears, keep it ambiguous and non-literal: a memory of Rob near the window, a hint of Horus outside, or Red Umbrielor's track-memory fading into the route. Avoid making it a ghost scene.
...
MERIDIAN PRIME WILL RETURN

**Lettering Note:** Caption, title/logo, website/socials, and any return text must stay inside the safe area. The landscape and cabin image may extend through bleed.

**Reveal Control:** May imply Rob's final agency. Do not reveal the House's full secrets, the exact route destination, or the full pistol function.

---

## Review Notes for Pages 1-24
...
- Whether Tenet's entrance feels grounded in work rather than exposition.
...
### What Pages 23-24 Test

- Whether Page 23 gives the reader a breath without losing Traverse mood.
- Whether the in-world warning poster strengthens NCI / Traverse identity.
- Whether Page 24 echoes Page 3 and closes the issue on Rob's agency.
- Whether the final caption lands as myth sting rather than explanation.

### Complete Draft Polish Targets

- Rob should sound warm, blunt, funny, and dying without becoming a riddle-machine.
- Tenet should remain practical, field-grounded, and emotionally controlled.
- Lindy's banter should carry pain without overexplaining family history.
- Rudy, Forest, and Ildi should each own a distinct truth domain.
- The hidden formation should feel huge but not solved.
- The footprints page should stay quiet.
- Page 22 should land as emotional recognition, not a lore diagram.
- Pages 23-24 should close the pressure case, not add a new plot mechanism.

### Current Candidate Canon Items To Watch

- Packet-style credits page.
