...
**Status:** Sandbox Music Style Card / Non-Canon / Requires Review Before Promotion  
**Collective Identity:** Dead Mile Cipher  
...
Dead Mile Cipher is Meridian Prime’s underground backpack rap collective.

Their sound blends:

- abstract indie-rap experimentation
- emotionally direct underground rap
- mythic crew architecture
- dusty boom-bap drums
- chopped field recordings
- pirate-radio fragments
- corporate paperwork satire
- false shelter rumors
- Low Road oral history
- factional argument

They should feel like a crew trading verses inside an illegal archive van while the route map changes under the tires.
...
```text
Dead Mile Cipher, underground backpack rap collective, abstract boom-bap, dusty crate-digging drums, chopped field recordings, pirate-radio samples, cracked jazz loops, cold minor-key piano stabs, dry bassline, turntable scratches, low-bit service tones, tape hiss, stencil-wall percussion, emotionally direct verses, dense internal rhyme schemes, surreal route logic, anti-corporate satire, mythic crew chants, factional slang, Low Road oral history, false shelter rumors, map graffiti, cypher energy, no glossy trap, no pop rap polish, no real artist names
```
...
Dead Mile Cipher lyrics should be readable as rap verses first.

Use:

- compact 12 to 16 line verses
- internal rhyme clusters
- concrete factional images
- one chantable hook
...
- overexplaining lore
- turning every line into exposition
...
faction arguments
survivor testimony
pirate radio samples
map contradictions
Dead Mile Cipher crew mythology
```

Possible hook language:
