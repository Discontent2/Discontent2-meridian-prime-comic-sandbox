...
**Purpose:** Search metadata index for Meridian Prime music style cards.

---

## Why This Exists

Some band identities are embedded inside individual style cards, which can make broad lookup difficult. This file gives every known style card a compact searchable metadata block without requiring destructive rewrites of older style-card files.

Use this file to answer:

```text
what style cards exist
what band uses this style
which style card belongs to Gentrification
...
| Style Card | Band / Project Identity | Primary Style | Repo Path | Related Albums / Projects | Related Songs / Examples |
|---|---|---|---|---|---|
| Pink Style | Mergenta | Haunted VHS horror-pop / hypnagogic cassette pop | `docs/music/bad-influence/style-cards/pink-style.md` | TBD Singles / Horror-Pop Tests | Another Weeknight, Black Lipstick, Eden Nurse |
...
## Lookup Metadata Blocks

### Mergenta

```text
Band Identity: Mergenta
Primary Style: Pink Style
Search Aliases: Pink Style, VHS horror-pop, hypnagogic horror-pop, cassette bedroom-pop, toy-synth, haunted television, Mergenta
Style Card: docs/music/bad-influence/style-cards/pink-style.md
...
```text
Band Identity: The Snifters
Primary Style: Growlers Style
Search Aliases: Growlers Style, surf-goth, beach-noir, garage psych, slacker croon, crooked roadhouse, The Snifters
Style Card: docs/music/bad-influence/style-cards/growlers-style.md
Registry Files: docs/music/band-registry.md, docs/music/album-registry.md, docs/music/song-index.md
```
...
```text
Band Identity: Time Bastard
Primary Style: Zombie Style
Search Aliases: Time Bastard, Time Bastards, Zombie Style, Low Road, horror-boogie, industrial groove, roadhouse metal, Route to Hell-Wreck Deluxe
Style Card: docs/music/bad-influence/style-cards/zombie-style.md
Registry Files: docs/music/band-registry.md, docs/music/album-registry.md, docs/music/song-index.md
```
...
```text
Band Identity: Gentrification
Primary Style: Underground Beach Goth
Search Aliases: Gentrification, Beach Goth, underground Beach Goth, creature tracks, cassette surf-goth, haunted beach garage, backyard CD-R, Tin Grin format
Style Card: docs/music/bad-influence/style-cards/gentrification-style.md
Registry Files: docs/music/band-registry.md, docs/music/album-registry.md, docs/music/song-index.md
```
...
Search Aliases: Dead Mile Cipher, Dead Mile Cypher, DMC, underground backpack rap, abstract boom-bap, field-tape rap, pirate radio rap, Low Road rap, map wrong miles right, Annotations from the Low Road, Arrestthemall Records
...
```text
Band Identity: Gloomed Vug
Label: Arrestthemall Records
Primary Style: Saurian grave-trap / haunted dirt rap
Search Aliases: Gloomed Vug, Arrestthemall Records, Tumulus, Shade Masiff, Ankylosapien, Bajadrasapien, young Aeonolacertian underground, saurian grave-trap, haunted dirt rap, mineral-cave reverb, blown-out bass, cemetery synths, grave-bell melodies, cloak-rustle percussion
Style Card: docs/music/bad-influence/style-cards/gloomed-vug-style.md
Collective Profile: docs/music/collectives/gloomed-vug.md
Core Members: Tumulus, Shade Masiff
Member Cards: docs/music/collectives/gloomed-vug/tumulus.md, docs/music/collectives/gloomed-vug/shade-masiff.md
Registry Files: docs/music/band-registry.md, docs/music/album-registry.md, docs/music/song-index.md
```
