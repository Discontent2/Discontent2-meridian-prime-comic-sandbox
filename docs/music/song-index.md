...
| Enum Core BGM | Enum Rage Engine | Worldskin: Original 16-Bit Soundtrack | Drafted and saved | deep 16-bit industrial doom EBM / Null Cavern dark reprise | Track 8 for Worldskin Game Realm. The Enum Core / WS-08 Core Membrane Nexus, brutal crushing cartridge pressure. File: `docs/music/songs/enum-rage-engine/enum-core-bgm.md`. |
...
Use for background-music-safe Enum tracks like `Null Cavern BGM`, `Rust Marsh BGM`, `Relay Spires BGM`, `Furnace District BGM`, `Graveyard Arcade BGM`, `Orbital Rootworks BGM`, and `Enum Core BGM`:
