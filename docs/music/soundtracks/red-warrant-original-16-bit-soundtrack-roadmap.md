# Red Warrant: Original 16-Bit Soundtrack Roadmap

**Status:** Devilment Studio BGM Roadmap / Meridian Prime Extended Universe / Non-Canon Until Promoted  
**Game Concept:** `docs/game-concepts/red-warrant/red-warrant-game-concept.md`  
...
## Core Soundtrack Mission

`Red Warrant` needs tracks.

The soundtrack should deliver aggressive, playable, loop-safe 16-bit BGM for a fast side-scrolling combat platformer / beat-'em-up shooter hybrid.

This is not a band album first. It is game BGM first.
...
aggressive FM guitar-like lead
fake chip kick
tiny digital snare tick
metallic FM hat
industrial chip sub pressure
...
```text
Writ Hammer writes the riot.
Pit ROM loads it into the cartridge.
Devilment Studio turns it into stages.
```
...
```text
If it sounds like gameplay information, keep it out of the BGM.
If it sounds like violence in the room, it can stay.
```
...
| 5 | Evidence Furnace | Industrial disposal stage | Pit ROM | Needs generation | Hot chip bass, furnace pulse, burned-document atmosphere, no literal fire effects. |
| 6 | Eviction Mech Factory | Machine assembly / hazard stage | Pit ROM | Needs generation | Mechanical thrash groove, factory pulse, stomping breakdown, no UI or alarm sounds. |
| 7 | Civic Teeth Arena | Mid-game boss arena / public spectacle | Pit ROM | Needs generation | Crowdless arena pressure, hooky combat riff, violent but loop-safe. |
| 8 | Black Van Procession | Moving convoy / chase stage | Pit ROM | Needs generation | Speed-metal drive, motor pressure without engine SFX, relentless chase bass. |
| 9 | Injunction Tower | Late-game vertical fortress | Pit ROM | Needs generation | Cold legal-machine ascent, progressive tension, climbing FM arps, harder breaks. |
...
## Expanded Track Candidates

Use these after the core 12 if the game needs more coverage.

| # | Track | Function | Notes |
|---|---|---|---|
| 13 | Title Screen: Stamped Awake | Title / attract mode | The cartridge wakes under a red legal stamp. |
| 14 | File Select: Evidence Locker | Save/load screen | Memory slots as bagged evidence. |
| 15 | Weapon Room: Chain of Custody | Upgrade / equipment screen | No menu sounds, just low cartridge pressure. |
| 16 | Boss Rush: Summary Judgment | Boss rush / challenge mode | Faster reprise of boss motifs. |
| 17 | Secret Stage: Paper Mill Below | Hidden level | Documents become machinery. |
| 18 | Credits: No Final Ruling | Staff roll | Legal ending unresolved, slow controlled release. |
...
## Track Generation Format

Each generated track should include:

```text
Title
Internal subtitle if useful
Artist
Function
Status
Core concept
Suno Style / Prompt Box
Suno Lyrics Box / bracket-only arrangement
Suno Exclude Box
Track Identity
Search Tags
```
...
```text
Red Warrant
Red Warrant Original 16-Bit Soundtrack
Devilment Studio
Pit ROM
Writ Hammer
Dane Killreceipt
...
Riot Permit Office
Underpass Tribunal
Red Warrant Rooftops
Evidence Furnace
Eviction Mech Factory
Civic Teeth Arena
Black Van Procession
Injunction Tower
The Clerk of Force
Denied Appeal
Case Left Open
Meridian Prime Extended Universe
